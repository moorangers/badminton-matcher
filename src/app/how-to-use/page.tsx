    ...
    <div className="min-h-dvh bg-gradient-surface pb-16">
      ...
      <main className="mx-auto w-full max-w-2xl space-y-4 px-3 py-4 sm:space-y-5 sm:px-6 sm:py-8">
        ...
        <Section title="2. เพิ่มผู้เล่น">
          ...
          <p>
            ผู้เล่นที่เพิ่มผ่านหน้านี้จะพร้อมลงคอร์ดได้ทันที (ถือว่าเช็คอินแล้ว เพราะแอดมินเพิ่มตรงหน้าคอร์ด)
          </p>
          <p>
        ...
        <Section title="ให้ผู้เล่นลงชื่อ/เช็คอินด้วยตัวเอง (ไม่ต้องมี PIN)">
          <p>
            ในหน้า dashboard จะมีการ์ด <strong className="text-foreground">“ลิงก์ลงชื่อ/เช็คอินด้วยตัวเอง”</strong>{' '}
            พร้อม QR code — ให้ผู้เล่นสแกนหรือเปิดลิงก์นั้นจากมือถือตัวเอง แล้วเลือกได้ 2 แบบ:
          </p>
          <ul className="list-disc space-y-1 pl-5">
            <li>
              <strong className="text-foreground">ลงชื่อล่วงหน้า</strong> — สำหรับคนที่ยังไม่ถึงคอร์ด
              (เช่น ลงชื่อจากบ้านว่าจะมา) จะยังไม่ถูกเอาไปสุ่มจนกว่าจะเช็คอินอีกที
            </li>
            <li>
              <strong className="text-foreground">เช็คอินเลย</strong> — สำหรับคนที่ถึงคอร์ดแล้ว
              (ทั้งคนที่เคยลงชื่อไว้ก่อน หรือ walk-in ที่ไม่เคยลงทะเบียนมาก่อนเลยก็ได้)
              พร้อมเข้าคิวสุ่มทันที
            </li>
          </ul>
          <p>
            คนที่ลงชื่อล่วงหน้าแต่ยังไม่เช็คอิน จะโผล่ในหน้า dashboard ที่การ์ด{' '}
            <strong className="text-foreground">“รอเช็คอิน”</strong> — ถ้าเขาไม่มีมือถือ
            แอดมินกดที่ชื่อในการ์ดนี้เพื่อเช็คอินแทนให้ได้เลย
          </p>
        </Section>
        ...
        <Section title="นับคะแนน + จอคะแนนสด">
          <p>
            กลางการ์ดแมตช์แต่ละคอร์ดมีปุ่ม <strong className="text-foreground">+/-</strong> ให้กดนับคะแนนแต่ละทีม
            ต้องนำห่างอย่างน้อย 2 แต้มถึงจะชนะเกม เมื่อฝั่งไหนชนะเกมจะขึ้นป้ายบอกทันที
          </p>
          <p>
            ปรับ <strong className="text-foreground">คะแนนเป้าหมายต่อเกม</strong> ได้ (ค่าเริ่มต้น 21 แต้มตามกติกาแบดมินตัน
            แต่เลือก 11/15 หรือกำหนดเองได้) ตั้งได้ตอนสร้าง session, ก่อนกด "เริ่มจับคู่" รอบแรก
            หรือแก้ผ่าน "ปรับรอบถัดไป" — แมตช์ที่กำลังเล่นอยู่จะไม่เปลี่ยนตามถ้าแก้ค่านี้ทีหลัง
            มีผลแค่กับแมตช์ใหม่ที่ยังไม่ถูกสร้าง
          </p>
          <p>
            กดไอคอนจอทีวี (📺 "จอคะแนนสด") มุมขวาบนของหน้า dashboard เพื่อเปิดหน้าจอคะแนนสด
            เอาไปเปิดบนทีวี/โปรเจกเตอร์ข้างคอร์ดได้เลย ไม่ต้องมี PIN หน้าจะอัปเดตให้เองทุก 2 วินาที
          </p>
        </Section>
